...
namespace DataLayer.Access.Data
{
       ...
       IdentityUserRole<Guid>, IdentityUserLogin<Guid>, IdentityRoleClaim<Guid>, IdentityUserToken<Guid>>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfiguration(new ShopCategorySpecificationRelationMap());
            builder.ApplyConfiguration(new WebCityAndStateMap());
            builder.ApplyConfiguration(new WebUserSpecificationMap());
            builder.ApplyConfiguration(new WebFolderMap());
